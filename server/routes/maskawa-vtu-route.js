...
const { allPlans, getCables, getNetworks, getNetworkId, getCableId, airtimeTopup, purchaseData, cableSubscription, getPlansByNetwork } = require('../controllers/maskawa-vtu-controller.js');
